...
export default function FirstIndex () {
    return (
        <>
            ...
            <div className="bg-yellow-900 text-gray-50 py-2 flex gap-4 justify-center items-center">
                <p className="font-mono text-xs font-thin">Get the latest news from Madagascar</p>
            ...
            <div className="p-5 flex flex-col gap-5">
                ...
                <a className="flex gap-4 bg-gray-100 p-4 w-max group hover:bg-yellow-900 rounded-sm" href="/about">
